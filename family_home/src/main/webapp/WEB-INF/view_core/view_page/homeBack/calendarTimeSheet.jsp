...
<script src="${ctx}/page_resource/homeBack/timeSheet/js/calendarTimeSheet.js"></script>
<div class="span9">
        ...
        <div class="span9" style="background-color: white">
            <div class="box" style="border-top: 0px;">
                <div class="box-header">
                    <h3 class="box-title">工时</h3>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio" value="2" checked="checked" name="type"><span style="padding-top: 5px;">&nbsp;课题任务</span>
