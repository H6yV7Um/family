...
<body>
	<!--<link href="${ctx}/common/ui/bootstrap/css/bootstrap.css?2023" rel="stylesheet" type="text/css" />-->
	<!--[if lte IE 6]>
	<link rel="stylesheet" type="text/css" href="${ctx}/common/ui/bootstrap/css/bootstrap-ie6.css?2023"/>
	<![endif]-->
	<!--[if lte IE 7]>
	<link rel="stylesheet" type="text/css" href="${ctx}/common/ui/bootstrap/css/ie.css?2023"/>
	<![endif]-->
	<link href="${ctx}/common/css/workflow/site.css?2023" rel="stylesheet" type="text/css" />
	...
	<div class="container">
		<form method="post" id="saveform" name="saveform" action="/index.php?s=/index/parse.html">
			...
			<div class="" style="padding: 8px 35px 8px 14px;
						margin-bottom: 20px;
			...
			<div class="row">
				...
				<div class="col-sm-10">
					...
					<script id="myFormDesign" type="text/plain" style="width:100%;">
						...
						{|-<span leipiplugins="radios"  title="单选" name="leipiNewField">
							...
							<input  value="单选2"  type="radio"/>单选2&nbsp;
								...
								<tr>
									...
									<td valign="top" style="border-color: rgb(221, 221, 221);" width="312">
										<img name="leipiNewField" title="雷劈网" value="http://www.leipi.org" orgtype="url" leipiplugins="qrcode" src="${ctx}/common/ui/ueditor/formdesign/images/qrcode.gif" orgwidth="40" orgheight="40" style="width: 40px; height: 40px;"/>
									</td>
								</tr>
							</tbody>
						</table>
						...
						<p>
							<img name="leipiNewField" title="进度条" leipiplugins="progressbar" orgvalue="20" orgsigntype="progress-info" src="${ctx}/common/ui/ueditor/formdesign/images/progressbar.gif"/>
						</p>
						</script>
				</div>
	...
	<!--<script type="text/javascript" charset="utf-8" src="${ctx}/common/js/jQuery/jquery-1.7.2.min.js?2023"></script>-->

	<script type="text/javascript" charset="utf-8" src="${ctx}/common/ui/ueditor/ueditor.config.js?2023"></script>
	<script type="text/javascript" charset="utf-8" src="${ctx}/common/ui/ueditor/ueditor.all.js?2023"> </script>
	<script type="text/javascript" charset="utf-8" src="${ctx}/common/ui/ueditor/lang/zh-cn/zh-cn.js?2023"></script>
	<script type="text/javascript" charset="utf-8" src="${ctx}/common/ui/ueditor/formdesign/leipi.formdesign.v4.js?2023"></script>
	<!-- script start-->
