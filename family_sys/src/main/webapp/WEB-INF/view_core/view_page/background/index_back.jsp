    ...
    <div class="graphs">
        ...
        <div class="span_11">
            <div class="col-md-6 col_4">
                ...
                <!----Calender -------->
                <link rel="stylesheet" href="${ctx}/common/css/clndr.css" type="text/css" />
                <script src="${ctx}/common/js/background/underscore-min.js" type="text/javascript"></script>
                <script src="${ctx}/common/js/background/moment-2.2.1.js" type="text/javascript"></script>
                <script src="${ctx}/common/js/background/clndr.js" type="text/javascript"></script>
                <script src="${ctx}/common/js/background/site.js" type="text/javascript"></script>
                <!----End Calender -------->
            </div>
            <div class="col-md-6 col_5">
                ...
                <!-- map -->
                <link href="${ctx}/common/css/jqvmap.css" rel='stylesheet' type='text/css' />
                <script src="${ctx}/common/js/jQuery/jquery.vmap.js"></script>
                <script src="${ctx}/common/js/jQuery/jquery.vmap.sampledata.js" type="text/javascript"></script>
                <script src="${ctx}/common/js/jQuery/jquery.vmap.world.js" type="text/javascript"></script>
