...
<body>
	<script src="${ctx}/page_resource/background/workflow/js/workflowHisInstance.js"></script>
			...
			<div class="col-md-12 graphs">
				<div class="xs">
					...
					<div class="box" style="border-top: 0px">
										...
										<div class="box-tools">
											<div class="input-group input-group-sm" style="width: 150px;">
											   ...
											   <div class="input-group-btn">
												...
												<div class="input-group-btn">
													<button class="btn btn-default" onclick="selectProcessHistory(1)">
						...
						<!-- 分页模块  -->
						<div align="center">
							<ul id="paginationWorkflowHisInstance" class="pagination-sm"
