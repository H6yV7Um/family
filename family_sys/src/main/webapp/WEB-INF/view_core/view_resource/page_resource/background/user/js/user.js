...
function addUser(){
    ...
    window.location.href = family_ns.contextPath + "/view/background/userAdd";
}
/***
 * delete user
 */
function deleteUser(){
    ...
    family_ns.operateConfirmByAjax(function () {
        family_ns.submitAjax({
            ...
            url: family_ns.contextPath + "/user/adminLog/userDel?businessId=" + businessId,
...
function initRoleGrid(page){
    ...
    family_ns.submitAjax({
        ...
        data: {page:rolePage,rows:10,sort:'checked desc'} ,
