...
var instanceParam = {};
var tbodyId = "flowInstanceTbody";
var tbodyCheck = "workflowInstanceCheck";


$(function(){
	queryWorkflowInstance.call(this,1);
});
/**
 * 查询数据库的所有流程实例信息
 * D_xm
 */
function queryWorkflowInstance(page){
	...
	family_ns.queryAjax({
		 type: 'POST',
		 data:data,
	     url: family_ns.contextPath + "/workflow/central/queryWorkflowInstance" ,
	     dataType: 'json',
	       success:function(results){
	            ...
	            initPagination.call(this,'paginationWorkflowInstance',results.pages,results.pageNu,"queryWorkflowInstance");
