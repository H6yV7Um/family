 ...
 * @date 2016年5月22日
 */
public class DecryptDBPasswordUtility {
	...
	public static void main(String[] args) throws Exception {
		String password = "";
		String decryptPassword= "bNVOqb7WKLX5Bjnw+LMv92taj25KOxDimXxILPQjw42wgv+1lHzOH8kr97xDwWdhpY67QuYCS7sWN4W46YbkFA==";
//		String[] arr = genKeyPair(512);
//		System.out.println("privateKey:" + arr[0]);
//		System.out.println("publicKey:" + arr[1]);
		System.out.println("encrypt-password:" + encrypt(DEFAULT_PRIVATE_KEY_STRING, "cy"));
