!function(c) {
	...
	var e = function(h, g) {
		...
		this.picker = c((this.bootcssVer == 3) ? b.templateV3 : b.template)
				.appendTo(this.isInline ? this.element : this.container).on({
	...
	e.prototype = {
		...
		update : function() {
			...
			if (arguments
				...
				g = (this.isInput ? this.element.val() : this.element.find(
						"input").val())
	...
	c.fn.datetimepicker = function(i) {
		...
		this
				.each(function() {
					var l = c(this), k = l.data("datetimepicker"), j = typeof i == "object"
							&& i;
					if (!k) {
						l.data("datetimepicker", (k = new e(this, c.extend({},
								c.fn.datetimepicker.defaults, j))))
					}
	...
	var b = {
		...
		headTemplate : '<thead><tr><th class="prev"><span class="glyphicon glyphicon-arrow-left"></span> </th><th colspan="5" class="switch"></th><th class="next"><span class="glyphicon glyphicon-arrow-right"></span> </th></tr></thead>',
